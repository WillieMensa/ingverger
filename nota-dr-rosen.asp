...
<html>
<head>
<title>Ing. Guillermo Verger - Diseño, CAD, Ingenio</title>
<!--#include file="GenericHeading.asp"-->
<link rel="stylesheet" href="css/nav.css">
<link rel="stylesheet" href="css/ingverger.css" >

</head>

<body><!-- Banner -->
	<p class="banner">Nota Dr. Mario Rosen</p><!--#include file="menu2015.shtml" -->
	<a name="TopOfPage"></a>
	<table width="1120" class="ex1"><!-- <table width="1120" border="01" cellspacing="0" cellpadding="0" > -->
	<tr>
 <td width="16" class="ex1">&nbsp;</td><!-- margen izquierdo -->
 <td width="750" class="ex1"><!-- contenido -->
	<div class="contenido">

<p> Hace un tiempo la esta nota con la que no se puede menos que coincidir. Cada vez que la releo compruebo
que mantiene total actualidad. La quiero compartir con ustedes. Aqui va.

<h4>La Argentina Insolente</h4>

<p>En mi casa me enseñaron bien.
<p>Cuando yo era un niño, en mi casa me enseñaron a honrar dos reglas sagradas:
<ul>
<li>Regla N° 1: En esta casa las reglas no se discuten.
<li>Regla N° 2: En esta casa se debe respetar a papá y mamá.  (Una versión casera del Cuarto Mandamiento: «Honra a tu padre y a tu madre, para que se prolonguen tus días sobre la tierra que el Señor, tu Dios, te va a dar» (Ex 20, 12).</li>
</ul>
<p>Y esta regla se cumplía en ese estricto orden. Una exigencia de mam, que
...
<p>No había que pagar rescate o ir a retirarlos a la morgue. El respeto por la
Autoridad de papá (desde luego, otorgada y sostenida graciosamente por mi
mamá) era razón suficiente para cumplir las reglas.

<p>Usted probablemente dirá que ya desde chiquito yo era un sometido, un
...
<p>Las reglas a cumplir eran fáciles, claras, memorables y tan reales y
consistentes como eran “lavarse las manos antes de sentarse a la mesa”
o “escuchar cuando los mayores hablan”.

<p>Había otro detalle, las mismas personas que me imponían las reglas eran las
...
<p>Sin embargo, y no lo dude, muchas veces desafié “las reglas” mediante el
...
<p>La travesura y el castigo pertenecían a un mismo sabio proceso que me
...
<p>El castigo era una salida terapéutica y elegante para todos, pues alejaba el
...
<p>Así fue en mi casa. Y así se suponía que era más allá de la esquina de mi
...
<p>El mundo al cual me arrojaron sin anestesia estaba patas para arriba.
Conocí algo que, desde mi ingenuidad adulta (si, aún sigo siendo un
...
<p>Le explicaré: Justicia, porque “el que las hace las paga”. Piedad, porque
...
<p>Las reglas eran claras. Los castigos eran claros. Así fue en mi casa.
...
<ul>
<li>Regla N° 3: No sea insolente. Si rompió la
  regla, acéptelo, hágase responsable, y haga lo que necesita ser hecho
  para poner las cosas en su lugar.</li>

</ul>
<p>Ésta es la regla que fue demolida en la sociedad en la que vivo. Eso es lo
...
<p>El mal de los Argentinos es la insolencia. La insolencia está compuesta de
petulancia, descaro y desvergüenza. La insolencia hace un culto de cuatro
principios:

<ul>
	<li>Pretender saberlo todo
	<li>Tener razón hasta morir
	<li>No escuchar
	<li>Tú me importas, sólo si me sirves.</li>
</ul>

<p>La insolencia en mi país admite que la gente se muera de hambre y que los
...
<p>Bueno, y así están las cosas. Ah, me olvidaba, ¿Las reglas sagradas de mi
...
<p><b>PORQUE ES MÁS CÓMODO</b>, y uno se acostumbra a cualquier cosa, para no tener
...
<p>Le propongo que hagamos algo para identificarnos entre nosotros. No tire
...
<p>Si es peatón, cruce por donde corresponde y respete los semáforos, aunque no
pase ningún vehículo, quédese parado y respete la regla.

<p>Si es un automovilista, respete los semáforos y respete los derechos del
peatón. Si saca a pasear a su perro, levante los desperdicios.

<p>Todo esto parece muy tonto, pero no lo crea, es el único modo de comenzar a
...
<p>Porque hay que aprender a hacerlo todos los días. Ése es el desafío.
...
<p>¿A USTED QUÉ LE PARECE? ¿PODREMOS RECONOCERNOS EN LA CALLE ?
<p>Espero no haber sido insolente. En ese caso, disculpe.
<p>
<p>Dr. Mario Rosen
<p>
...
<hr>
	  ...
	  </div><!-- Cuadro de busqueda -->
	  
 <p align="center" style="MARGIN-TOP: 0px; MARGIN-BOTTOM: 0px">&nbsp;</p>

	  <table border="2" cellpadding="5" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="400" id="AutoNumber9">
  <tr>
 <td>

		<p>Busca más información en nuestro sitio con
   la potencia de Google <!-- SiteSearch Google -->
		...
		<td nowrap>
		<input type="hidden" name="domains" value="www.ingverger.com.ar"></input>
		<label for="sbi" style="DISPLAY: none">Introduzca los términos de búsqueda.</label>
		<input name="q" size="40" maxlength="255" id="sbi" ></input>
		...
		<td>
		<input type="radio" name="sitesearch" value="www.ingverger.com.ar" checked id="ss1"></input>
		<label for="ss1" title="Búsqueda www.ingverger.com.ar"><font size="-1" color="#000000">www.ingverger.com.ar</font></label></td>
		</tr>
		</table>
		<input type="hidden" name="client" value="pub-4076082038101002"></input>
		...
		</form><!-- SiteSearch Google --><!-- <p align="center" style="margin-top: 0; margin-bottom: 0">&nbsp;</td> --></p></td>
  </tr>
   </table>
...
<br>
 ...
 <a href="http://validator.w3.org/check?uri=referer"><img
  ...
  </p><!-- Validacion de pagina
http://validator.w3.org/check?uri=http%3A%2F%2Fwww.ingverger.com.ar%2F
 -->
</body>
</html>
