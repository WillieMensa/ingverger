...
<head>
	...
	<title>SUMADO</title>
	<meta name="description" content="SUMADO, un juego de lógica.">
...
<div class="container">
	...
	<h1>SUMADO. Un juego de lógica</h1>
	<hr>
	<div class="row">
		<div class="col-sm-8">

			<p>SUMADO es un juego de lógica que requiere un minimo conocimiento de aritmetica para ser resuelto. Es una oportunidad de gimnasia mental y diversion al mismo tiempo.

			<p>Se trata de un conjunto de círculos unidos por líneas que forman cuadrados y triángulos. &nbsp;En los círculos o vértices de cada figura se ha asignado un n&uacute;mero diferente entre uno y nueve. &nbsp;En cada figura se muestra la suma resultante de los correspondientes vértices. El objeto del juego es deducir los valores asignados a cada círculo.  Se dan como ayuda los valores de dos vértices.</p>
			...
			<ul>
				...
				<li><a href="sumado/index.html" target="_blank">Jugar en línea</a></li>
			</ul>
		</div>
