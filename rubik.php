...
<head>
	...
	<meta name="keywords" content="Sistemas de Representación, CAD 3D, caligrafía técnica,ingenio, Resolución cubo de Rubik, rompecabezas">
...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-sm-7">
			<p>Las notas que siguen las hice, originalmente para mi mismo, como un recordatorio de los pasos que debía seguir para resolver el cubo de Rubik.<br>
			A esas notas agregué las convenciones utilizadas para que se me pueda comenzar a entender.<br>
	...
	<div class="row">
		...
		<p>Cada cara del cubo estará vinculada a una letra para identificar los movimientos que se deben realizar. Utilizaremos una convención ampliamente difundida que proviene de la identificación en inglés.</p>
		<dl>
		...
		<h3>Colores</h3>
		<p>Al referirnos a caras de los cubitos individuales que deben tener el mismo color los mostraremos todos de un mismo color. Las caras de cubitos que queden blancas será porque no importa el color de las mismas.</p>
		</div>
	...
	<div class="row">
		...
		<div class="col-sm-7">
		<h2>Paso 1</h2>
		<p>Elegir un color, por ejemplo, el blanco. Con el centro de cara blanco hacia arriba, mover las aristas blancas para hacer una cruz. Cada arista deberá coincidir en sus colores con el centro de la cara superior blanca y el centro de la cara lateral.</p>
	...
	<div class="row">
		...
		<p>La figura muestra una vista análoga a la que tenríamos que tener al completar este paso.</p>
		<p>&nbsp;
	...
	<div class="row">
		...
		<div class="col-sm-7">
			<h2>Comenzamos la tercera y última capa</h2>
			<p>En primer lugar invertimos la posición del cubo. La cara blanca quedará hacia abajo y, en el caso de un cubo standard, hacia arriba debería quedar la capa amarilla.<br>
			Lo más probable es que la ultima cara esté desordenada, con los cubitos fuera de lugar y girados de la posición que debieran tener.<br>
	...
	<div class="row">
		...
		<div class="col-sm-7">
			<h2>Paso 4</h2>
			<p>El objetivo es que se muestre una cruz con el color correcto, en nuestro caso sería el amarillo.</p>
			Según el caso en que nos encontremos realizaremos los siguientes movimientos:</P>
			<dl>
	...
	<div class="row">
		...
		<div class="col-sm-7">
			<h2>Paso 5</h2>
			<p>En este paso debemos mover los vértices para completar el color de la cara.</p>
			<p>La situación de partida puede ser</p>
			<p>
			&nbsp;
	...
	<div class="row">
		...
		<div class="col-sm-7">
			<h2>Paso 6</h2>
			<p>En este paso vamos a posicionar correctamente los vértices.</p>
			<p>Tenemos una secuencia que produce el desplazamiento en sentido horario de los vértices A, C e I. En definitiva, intercambia los vértices C e I.<br>
			&nbsp;&nbsp;&nbsp;R' F R' B B R F' R' B B R R U'</p>
			<p>Y tenemos una secuencia que permuta directamente los vértices C e I:<br>
	...
	<div class="row">
		...
		<div class="col-sm-7">
			<h2>Paso 7</h2>
			<p>En este paso vamos a posicionar correctamente las aristas de la última capa. Para esta operación disponemos de varias secuencias.</p>
			<dl>
	...
	<div class="row">
		...
		<div class="col-sm-7">
		<h2></h2>
		<p>Siguiendo los pasos anteriores nuestro cubo debería verse ordenado en forma similar a la que se ve en la imagen</p>
